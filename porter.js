...
(function() {
  var PORT, SECRET, authed, butler, checkPort, checkin, cleanup, droneName, getRoutingTable, http, listen, net, nginx, path, portfinder, router, server, spawn, spawnNginx, upnode, _ref;
